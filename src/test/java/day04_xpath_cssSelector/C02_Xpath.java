...
public class C02_Xpath {
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.xpath("//button[@onclick='addElement()']")).click(); // <-Adim 2

        Thread.sleep(2000);


        WebElement deleteButtonElementi = driver.findElement(By.xpath("//button[@class='added-manually']")); // <-Adim 3
        Thread.sleep(2000);
